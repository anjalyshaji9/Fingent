...
<table align="center" cellpadding="0" cellspacing="0" width="50%" height="100%" class="pad1">
	<tr>
                ...
                <tr>
                    <td colspan="4" width="100%" align="center" valign="top" class="home-content">
                        ...
                        <div class="panel-body">
                           <form name="frm_login" id="frm_login" method="post" action="<?php echo base_url();?>Admin">
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="form-group has-error">
                                            <label class="control-label" for="error"><?php echo form_error('password'); ?></label>
                                                                          </div>
                                        </div>
